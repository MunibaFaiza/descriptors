...
f=open('angle-coms.csv','a')

ang1=cmd.get_angle('tmp, /H6_COM/PSDO/P/PSD`1/PS1','/H7_COM/PSDO/P/PSD`1/PS1','/Hx_COM/PSDO/P/PSD`1/PS1')
ang2=cmd.get_angle('tmp, /H7_COM/PSDO/P/PSD`1/PS1','/Hx_COM/PSDO/P/PSD`1/PS1','/H12_COM/PSDO/P/PSD`1/PS1')
ang3=cmd.get_angle('tmp, /Hx_COM/PSDO/P/PSD`1/PS1','/H12_COM/PSDO/P/PSD`1/PS1','/H6_COM/PSDO/P/PSD`1/PS1')
ang4=cmd.get_angle('tmp, /H12_COM/PSDO/P/PSD`1/PS1','/H6_COM/PSDO/P/PSD`1/PS1','/H7_COM/PSDO/P/PSD`1/PS1')



    writer = csv.writer(f)
    writer.writerow( ('5yt2',"%10f\a"%ang1,"%10f\a"%ang2,"%10f\a"%ang3,"%10f\a"%ang4) )
